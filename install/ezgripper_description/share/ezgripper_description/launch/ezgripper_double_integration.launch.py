#!/usr/bin/env python3
"""
EZGripper Double Integration - Launch File for Integration with Other Components
This launch file is designed to integrate the EZGripper Double with other robot components
...
def generate_launch_description():
    ...
    # Include the double gripper component launch file
    ...
    shutdown_handler = RegisterEventHandler(
        OnShutdown(
            on_shutdown=[
                LogInfo(msg=['Shutting down EZGripper Double integration']),
    ...
    return LaunchDescription([
        ...
        # Include the double gripper component
        component_launch,
        shutdown_handler
    ])
